...
public class CustomPopupNotificationData extends inkGameNotificationData {
	public let controller: ref<CustomPopupController>;
}
...
@addMethod(PopupsManager)
protected cb func OnShowPopupEvent(evt: ref<ShowCustomPopupEvent>) -> Bool {
	let popupController: ref<CustomPopupController> = evt.GetPopup();
	...
	this.QueueNextFrameEvent(
		TryAttachCustomPopupEvent.Create(
			popupController,
			notificationData,
			notificationToken,
...
@addMethod(PopupsManager)
protected cb func OnTryAttachPopupEvent(evt: ref<TryAttachCustomPopupEvent>) -> Bool {
...
protected cb func OnPopupNotificationClosed(data: ref<inkGameNotificationData>) -> Bool {
	...
	let popupController: ref<CustomPopupController> = notificationData.controller;
...
@addMethod(PopupsManager)
protected cb func OnHidePopupEvent(evt: ref<HideCustomPopupEvent>) -> Bool {
	let popupController: ref<CustomPopupController> = evt.GetPopup();
